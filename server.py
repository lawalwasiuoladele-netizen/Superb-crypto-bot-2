"""
Patched server.py for Superb Crypto Bot — robust, safe debug endpoints.

Replace your existing server.py with this file and restart the service.
"""
import os
import json
import queue
...
# import your bot module (expects bot.BotController available)
import bot
...
def start():
    ...
    try:
        # allow a JSON payload to replace accounts (convenience)
...
def account_debug(acc_index: int):
    ...
    # Accept both key/secret and api_key/api_secret naming
    ...
    # safe default: do not assume testnet unless explicitly set per-account
    ...
    try:
        # import here to avoid module level failure if pybit missing
